...
async function sendStatusMail(to, text, rName, cName, jobTitle, company, status)
{
    ...
    if(status=="accepted")
        {
            ...
            <p style="margin: 0;">I hope this email finds you well. We are writing to inform you that ${cName} has accepted the offer for the ${jobTitle} position at ${company}.
...
const jobTitle = "CEO";
const company = "Apple";
const status = "finalJobOffer";

sendStatusMail(to, text, rName, cName, jobTitle, company, status);
